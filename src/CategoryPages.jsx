...
const CATEGORY_CONTENT = {
  ...
  machines: {
    ...
    label: 'BUILD',
    title: '車両製作',
    lead: '市販のままでは届かない場所へ行くために、何を選び、何を作り直したのか。長距離とダートを見据えた車両、そして長く乗って分かった機械の手応えを記録します。',
    statement: '売っていないなら、つくる。',
    description: 'KTM 990 ADVENTURE Sを12年乗った記録、KLR650のIMS 37Lタンク、R1200GSの60Lタンク。完成形だけでなく、選んだ理由と判断の過程まで残します。',
    heroImage: 'ktm-990-adv-s/01-dirt-slide.webp',
    heroAlt: 'ダートを走るKTM 990 ADVENTURE S',
    cards: [
      {
        number: '003',
        kicker: 'MACHINE PROFILE 003 / KTM 990 ADVENTURE S',
        title: '12年乗って分かった、ダートで際立つLC8。',
        excerpt: '2007年型のS、前後265mm、電子制御を介さない手応え。憧れを一台へ変え、12年走ったオーナーの記録。',
        image: 'ktm-990-adv-s/04-current-setup.webp',
        alt: 'Safari Tanks 40Lタンクを装着したKTM 990 ADVENTURE S',
        href: '/articles/ktm-990-adv-s/',
        linkLabel: '990 ADVENTURE Sを読む',
        featured: true,
      },
      {
        number: '001',
